#include <stdlib.h>
#include "cn_dennishucd_ImageEngine.h"
...
jintArray Java_cn_dennishucd_ImageEngine_toGray(JNIEnv* env,
...
jintArray Java_cn_dennishucd_ImageEngine_toFudiao(JNIEnv* env,
		jobject thiz, jintArray buf, jint width, jint height)
{
	jint * cbuf;
	cbuf = (*env)->GetIntArrayElements(env, buf, 0);
...
jintArray Java_cn_dennishucd_ImageEngine_toHeibai
...
jintArray Java_cn_dennishucd_ImageEngine_toMohu
...
jintArray Java_cn_dennishucd_ImageEngine_toDipian
  (JNIEnv* env,jobject thiz, jintArray buf, jint width, jint height)
{
	jint * cbuf;
    cbuf = (*env)->GetIntArrayElements(env, buf, 0);
...
jintArray Java_cn_dennishucd_ImageEngine_toSunshine
...
jintArray Java_cn_dennishucd_ImageEngine_toFangdajing
...
jintArray Java_cn_dennishucd_ImageEngine_toHahajing
  (JNIEnv* env,jobject thiz, jintArray buf, jint width, jint height,jint centerX, jint centerY, jint radius, jfloat multiple)
{
	    jint * cbuf;
		cbuf = (*env)->GetIntArrayElements(env, buf, 0);
